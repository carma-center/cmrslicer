<head>
  ...
  <meta charset="UTF-8">
  <title>Slicer CMR Toolkit</title>
...
/* ]]> */
  ...
  <meta name="description" content="Slicer CMR Toolkit">
  <meta name="keywords" content="cardiac MRI, image processing, atrial
...
<body class="carmasite">
  <div id="wrapper" class="hfeed">
    <div id="header">
      <div id="masthead">
        <div id="ttw-site-logo"></div>
        <div id="ttw-site-logo-link" onclick="location.href='http://BROKEN_LINK';" style="cursor:pointer;"></div>
        <h1 id="site-title">
          <span>
          ...
          <div>	
            <div style="width: 940px; height: 200px;" id="meteor-slideshowmyMeteorSlideShow" class="meteor-slides myMeteorSlideShow navnone { next: '#meteor-nextmyMeteorSlideShow', prev: '#meteor-prevmyMeteorSlideShow', pager: '#meteor-buttonsmyMeteorSlideShow' }">
             <div style="position: absolute; top: 0px; left: 0px; display: block; z-index: 4; opacity: 0.189221; width: 940px; height: 200px;" class="mslide mslide-1"> 
                <img src="carmabanner3.png" class="attachment-featured-slide wp-post-image" alt="" title="" height="200" width="940">					 
              </div><!-- .mslide --> 
                <div style="position: absolute; top: 0px; left: 0px; display: none; z-index: 3; width: 940px; height: 200px; opacity: 0;" class="mslide mslide-2">
                  <img src="carmabanner5.png" class="attachment-featured-slide wp-post-image" alt="" title="" height="200" width="940">					
                </div><!-- .mslide -->
               <div style="position: absolute; top: 0px; left: 0px; display: block; z-index: 3; width: 940px; height: 200px; opacity: 0.810779;" class="mslide mslide-3">
                 <img src="carmabanner1.png"
                 class="attachment-featured-slide wp-post-image"
                 alt="" title="" height="200" width="940">
                </div><!-- .mslide -->
               <div style="position: absolute; top: 0px; left: 0px; display: block; z-index: 3; width: 940px; height: 200px; opacity: 0.810779;" class="mslide mslide-3">
                 <img src="carmabanner2.png" class="attachment-featured-slide wp-post-image" alt="" title="" height="200" width="940">					
                </div><!-- .mslide -->
            </div><!-- .meteor-slides --><div>	    </div><!-- #branding -->
            <div id="nav-bottom-menu"><div id="access" role="navigation">
                <div class="menu">
                  <ul>
                    <li>The Comprehensive Arrhythmia Research and
                   Management Center</li>
                   <!-- <li class="current_page_item"> <img src="carmalogo.png" class="attachment-featured-slide
                                 wp-post-image"  alt="CARMA Center"
                                 width="120"></li> -->
                   <!-- <li class="current_page_item"> <img src="uofulogo2.png" class="attachment-featured-slide
                                                                                   wp-post-image"  alt="CARMA Center"
                                                        width="120"></li>-->
                      <!--<a href=""  title="Slicer CMR Toolkit Project Overview">Slicer CMR Toolkit Project Overview</a></li>-->
                    <!--  <li class="page_item page-item-19"><a href="./bibliography.html"  title="Selected Bibliography">Selected Bibliography</a>-->
                    <!--  <li class="page_item page-item-19"><a href="./decaaf" title="LINK">Example LINK)</a> -->
                </div>
            </div></div><!-- #access -->
